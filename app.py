...
# --- NOVA ROTA PARA CARREGAR UM PROJETO ESPECÍFICO ---
...
# (As rotas de análise, otimização e banco de dados de componentes permanecem inalteradas)
class AnalisadorDeSistema: # ... (código inalterado)
