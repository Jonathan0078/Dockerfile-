document.addEventListener('DOMContentLoaded', async () => {
    // Referências aos elementos principais (código inalterado)
    ...
    // --- MELHORIA: Carrega o banco de dados ao iniciar a página ---
    ...
    try {
        ...
        alert("Não foi possível carregar o banco de dados de componentes. Algumas funcionalidades podem não funcionar.");
    }

    // Lógica de Adição por Botão (código inalterado)
    ...
    // --- LÓGICA DO MODAL DE DADOS (AGORA INTELIGENTE) ---
    function openModalForComponent(id) {
        ...
        switch (component.type) {
            case 'rolamento':
                // Cria a lista de opções a partir do nosso banco de dados
                ...
                break;
            // Casos do motor e polias (código inalterado)
            case 'motor': fieldsHtml = `...`; break;
            case 'polia_motora': case 'polia_movida': fieldsHtml = `...`; break;
        }
        modalFields.innerHTML = fieldsHtml;

        // Adiciona o listener para o auto-preenchimento
    ...
    // (create, render, startDrag, drag, endDrag, modalForm submit, modalCloseBtn click, analyzeButton click, displayResults)
