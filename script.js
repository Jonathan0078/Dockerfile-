document.addEventListener('DOMContentLoaded', async () => {
    ...
    function renderWorkbench() {
        // Limpa apenas os componentes, não o canvas SVG
